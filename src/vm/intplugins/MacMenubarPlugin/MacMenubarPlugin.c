/* Automatically generated from Squeak on 17 September 2009 10:45:01 am 
   by VMMaker 3.11.3
 */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"MacMenubarPlugin 17 September 2009 (i)"
#else
	"MacMenubarPlugin 17 September 2009 (e)"
#endif
;
...
EXPORT(sqInt) primitiveDisposeMenuBar(void) {
	...
	menuBarHandle = ((Handle) (interpreterProxy->positive64BitValueOf(menuHandleOop)));
	#if TARGET_API_MAC_CARBON
...
EXPORT(sqInt) primitiveGetIndMenuItemWithCommandID(void) {
	...
	menuHandle = ((MenuHandle) (interpreterProxy->positive64BitValueOf(menuHandleOop)));
	commandID = ((MenuCommand) (interpreterProxy->positive64BitValueOf(aCommandID)));
	if (!(ioCheckMenuHandle(menuHandle))) {
		_return_value = interpreterProxy->success(0);
		if (interpreterProxy->failed()) {
			return null;
...
GetIndMenuItemWithCommandID(menuHandle, kHICommandHide, 1,
                   &applicationMenu, &outIndex);
#endif ;
	_return_value = interpreterProxy->positive64BitIntegerFor(((long) applicationMenu));
	if (interpreterProxy->failed()) {
		return null;
	}
	interpreterProxy->popthenPush(3, _return_value);
...
EXPORT(sqInt) primitiveGetMenuItemCommandID(void) {
	...
	_return_value = interpreterProxy->positive64BitIntegerFor(outCommandID);
	if (interpreterProxy->failed()) {
		return null;
	}
	interpreterProxy->popthenPush(3, _return_value);
...
EXPORT(sqInt) primitiveGetMenuItemKeyGlyph(void) {
	...
	_return_value = interpreterProxy->positive64BitIntegerFor(outGlyph);
	if (interpreterProxy->failed()) {
		return null;
	}
	interpreterProxy->popthenPush(3, _return_value);
...
EXPORT(sqInt) primitiveGetMenuItemTextEncoding(void) {
	...
	_return_value = interpreterProxy->positive64BitIntegerFor(outScriptID);
	if (interpreterProxy->failed()) {
		return null;
	}
	interpreterProxy->popthenPush(3, _return_value);
...
EXPORT(sqInt) primitiveInsertIntlResMenu(void) {
	...
	resType = ((ResType) (interpreterProxy->positive64BitValueOf(aResType)));
...
EXPORT(sqInt) primitiveSetMenuBar(void) {
	...
	menuBarHandle = ((MenuBarHandle) (interpreterProxy->positive64BitValueOf(menuHandleOop)));
...
EXPORT(sqInt) primitiveSetMenuItemCommandID(void) {
	...
	menuHandle = ((MenuHandle) (interpreterProxy->positive64BitValueOf(menuHandleOop)));
	commandID = ((MenuCommand) (interpreterProxy->positive64BitValueOf(inCommandID)));
	if (!(ioCheckMenuHandle(menuHandle))) {
		_return_value = interpreterProxy->success(0);
		if (interpreterProxy->failed()) {
			return null;
...
EXPORT(sqInt) primitiveSetMenuItemTextEncoding(void) {
	...
	inScriptID = ((TextEncoding) (interpreterProxy->positive64BitValueOf(aTextEncodingOop)));
